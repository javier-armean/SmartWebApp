...
exports.createAccountReject = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const account = this.parseRequired(options.account, 'string', 'stripe.createAccountReject: account is required.');
  delete options.account;
  return stripe.accounts.createReject(account, options,__extra);
};
...
exports.createChargeCapture = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const charge = this.parseRequired(options.charge, 'string', 'stripe.createChargeCapture: charge is required.');
  delete options.charge;
  return stripe.charges.createCapture(charge, options,__extra);
};
...
exports.createCreditNoteVoid = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const id = this.parseRequired(options.id, 'string', 'stripe.createCreditNoteVoid: id is required.');
  delete options.id;
  return stripe.creditNotes.createVoid(id, options,__extra);
};
...
exports.createDisputeClose = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const dispute = this.parseRequired(options.dispute, 'string', 'stripe.createDisputeClose: dispute is required.');
  delete options.dispute;
  return stripe.disputes.createClose(dispute, options,__extra);
};
...
exports.createIdentityVerificationSessionCancel = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const session = this.parseRequired(options.session, 'string', 'stripe.createIdentityVerificationSessionCancel: session is required.');
  delete options.session;
  return stripe.identity.verificationSessions.createCancel(session, options,__extra);
};

// /v1/identity/verification_sessions/{session}/redact - post
exports.createIdentityVerificationSessionRedact = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const session = this.parseRequired(options.session, 'string', 'stripe.createIdentityVerificationSessionRedact: session is required.');
  delete options.session;
  return stripe.identity.verificationSessions.createRedact(session, options,__extra);
};
...
exports.createInvoiceFinalize = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const invoice = this.parseRequired(options.invoice, 'string', 'stripe.createInvoiceFinalize: invoice is required.');
  delete options.invoice;
  return stripe.invoices.createFinalize(invoice, options,__extra);
};
...
exports.createInvoiceMarkUncollectible = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const invoice = this.parseRequired(options.invoice, 'string', 'stripe.createInvoiceMarkUncollectible: invoice is required.');
  delete options.invoice;
  return stripe.invoices.createMarkUncollectible(invoice, options,__extra);
};

// /v1/invoices/{invoice}/pay - post
exports.createInvoicePay = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const invoice = this.parseRequired(options.invoice, 'string', 'stripe.createInvoicePay: invoice is required.');
  delete options.invoice;
  return stripe.invoices.createPay(invoice, options,__extra);
};

// /v1/invoices/{invoice}/send - post
exports.createInvoiceSend = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const invoice = this.parseRequired(options.invoice, 'string', 'stripe.createInvoiceSend: invoice is required.');
  delete options.invoice;
  return stripe.invoices.createSend(invoice, options,__extra);
};

// /v1/invoices/{invoice}/void - post
exports.createInvoiceVoid = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const invoice = this.parseRequired(options.invoice, 'string', 'stripe.createInvoiceVoid: invoice is required.');
  delete options.invoice;
  return stripe.invoices.createVoid(invoice, options,__extra);
};
...
exports.createIssuingAuthorizationApprove = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const authorization = this.parseRequired(options.authorization, 'string', 'stripe.createIssuingAuthorizationApprove: authorization is required.');
  delete options.authorization;
  return stripe.issuing.authorizations.createApprove(authorization, options,__extra);
};

// /v1/issuing/authorizations/{authorization}/decline - post
exports.createIssuingAuthorizationDecline = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const authorization = this.parseRequired(options.authorization, 'string', 'stripe.createIssuingAuthorizationDecline: authorization is required.');
  delete options.authorization;
  return stripe.issuing.authorizations.createDecline(authorization, options,__extra);
};
...
exports.createIssuingDisputeSubmit = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const dispute = this.parseRequired(options.dispute, 'string', 'stripe.createIssuingDisputeSubmit: dispute is required.');
  delete options.dispute;
  return stripe.issuing.disputes.createSubmit(dispute, options,__extra);
};
...
exports.createOrderPay = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const id = this.parseRequired(options.id, 'string', 'stripe.createOrderPay: id is required.');
  delete options.id;
  return stripe.orders.createPay(id, options,__extra);
};
...
exports.createPaymentIntentCancel = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const intent = this.parseRequired(options.intent, 'string', 'stripe.createPaymentIntentCancel: intent is required.');
  delete options.intent;
  return stripe.paymentIntents.createCancel(intent, options,__extra);
};

// /v1/payment_intents/{intent}/capture - post
exports.createPaymentIntentCapture = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const intent = this.parseRequired(options.intent, 'string', 'stripe.createPaymentIntentCapture: intent is required.');
  delete options.intent;
  return stripe.paymentIntents.createCapture(intent, options,__extra);
};

// /v1/payment_intents/{intent}/confirm - post
exports.createPaymentIntentConfirm = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const intent = this.parseRequired(options.intent, 'string', 'stripe.createPaymentIntentConfirm: intent is required.');
  delete options.intent;
  return stripe.paymentIntents.createConfirm(intent, options,__extra);
};
...
exports.createPaymentMethodAttach = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const payment_method = this.parseRequired(options.payment_method, 'string', 'stripe.createPaymentMethodAttach: payment_method is required.');
  delete options.payment_method;
  return stripe.paymentMethods.createAttach(payment_method, options,__extra);
};

// /v1/payment_methods/{payment_method}/detach - post
exports.createPaymentMethodDetach = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const payment_method = this.parseRequired(options.payment_method, 'string', 'stripe.createPaymentMethodDetach: payment_method is required.');
  delete options.payment_method;
  return stripe.paymentMethods.createDetach(payment_method, options,__extra);
};
...
exports.createPayoutCancel = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const payout = this.parseRequired(options.payout, 'string', 'stripe.createPayoutCancel: payout is required.');
  delete options.payout;
  return stripe.payouts.createCancel(payout, options,__extra);
};

// /v1/payouts/{payout}/reverse - post
exports.createPayoutReverse = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const payout = this.parseRequired(options.payout, 'string', 'stripe.createPayoutReverse: payout is required.');
  delete options.payout;
  return stripe.payouts.createReverse(payout, options,__extra);
};
...
exports.createReviewApprove = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const review = this.parseRequired(options.review, 'string', 'stripe.createReviewApprove: review is required.');
  delete options.review;
  return stripe.reviews.createApprove(review, options,__extra);
};
...
exports.createSetupIntentCancel = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const intent = this.parseRequired(options.intent, 'string', 'stripe.createSetupIntentCancel: intent is required.');
  delete options.intent;
  return stripe.setupIntents.createCancel(intent, options,__extra);
};

// /v1/setup_intents/{intent}/confirm - post
exports.createSetupIntentConfirm = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const intent = this.parseRequired(options.intent, 'string', 'stripe.createSetupIntentConfirm: intent is required.');
  delete options.intent;
  return stripe.setupIntents.createConfirm(intent, options,__extra);
};
...
exports.createSourceVerify = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const source = this.parseRequired(options.source, 'string', 'stripe.createSourceVerify: source is required.');
  delete options.source;
  return stripe.sources.createVerify(source, options,__extra);
};
...
exports.createSubscriptionScheduleCancel = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const schedule = this.parseRequired(options.schedule, 'string', 'stripe.createSubscriptionScheduleCancel: schedule is required.');
  delete options.schedule;
  return stripe.subscriptionSchedules.createCancel(schedule, options,__extra);
};

// /v1/subscription_schedules/{schedule}/release - post
exports.createSubscriptionScheduleRelease = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const schedule = this.parseRequired(options.schedule, 'string', 'stripe.createSubscriptionScheduleRelease: schedule is required.');
  delete options.schedule;
  return stripe.subscriptionSchedules.createRelease(schedule, options,__extra);
};
...
exports.createTopupCancel = function(options) {
  options = this.parse(options);
  var __extra = options.__extra;
  if (options.__extra) {
    __extra = convertExtraOptions(__extra);
  ...
  const topup = this.parseRequired(options.topup, 'string', 'stripe.createTopupCancel: topup is required.');
  delete options.topup;
  return stripe.topups.createCancel(topup, options,__extra);
};
